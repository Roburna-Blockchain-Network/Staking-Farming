...
async function main() {
  ...
  await rbaContract.approve(rewardWalletContract.address, ethers.utils.parseEther("10000000"), {
    gasPrice: gasPrice
  })
  await rewardWalletContract.deposit(ethers.utils.parseEther("10000"), {
    gasPrice: gasPrice
  })
